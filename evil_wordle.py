...
On my/our honor, Shasa Lloyd Kolar, this
...
class Keyboard:
    ...
    def update(self, feedback_colors, guessed_word):
        ...
        while counter < 5:
            if feedback_colors[counter] == CORRECT_COLOR:
                self.colors[guessed_letters[counter]] = CORRECT_COLOR
            elif feedback_colors[counter] == WRONG_SPOT_COLOR and\
            self.colors[guessed_letters[counter]] == NO_COLOR:
                self.colors[guessed_letters[counter]] = WRONG_SPOT_COLOR
            counter += 1
